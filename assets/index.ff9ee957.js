 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,U){var H=D.length;D.push(U);e:for(;0<H;){var ae=H-1>>>1,ce=D[ae];if(0<i(ce,U))D[ae]=U,D[H]=ce,H=ae;else break e}}function n(D){return D.length===0?null:D[0]}function r(D){if(D.length===0)return null;var U=D[0],H=D.pop();if(H!==U){D[0]=H;e:for(var ae=0,ce=D.length,_t=ce>>>1;ae<_t;){var tt=2*(ae+1)-1,hn=D[tt],Et=tt+1,Qt=D[Et];if(0>i(hn,H))Et<ce&&0>i(Qt,hn)?(D[ae]=Qt,D[Et]=H,ae=Et):(D[ae]=hn,D[tt]=H,ae=tt);else if(Et<ce&&0>i(Qt,H))D[ae]=Qt,D[Et]=H,ae=Et;else break e}}return U}function i(D,U){var H=D.sortIndex-U.sortIndex;return H!==0?H:D.id-U.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,m=!1,y=!1,_=!1,T=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(D){for(var U=n(u);U!==null;){if(U.callback===null)r(u);else if(U.startTime<=D)r(u),U.sortIndex=U.expirationTime,e(l,U);else break;U=n(u)}}function w(D){if(_=!1,p(D),!y)if(n(l)!==null)y=!0,z(E);else{var U=n(u);U!==null&&K(w,U.startTime-D)}}function E(D,U){y=!1,_&&(_=!1,g(I),I=-1),m=!0;var H=d;try{for(p(U),h=n(l);h!==null&&(!(h.expirationTime>U)||D&&!B());){var ae=h.callback;if(typeof ae=="function"){h.callback=null,d=h.priorityLevel;var ce=ae(h.expirationTime<=U);U=t.unstable_now(),typeof ce=="function"?h.callback=ce:h===n(l)&&r(l),p(U)}else r(l);h=n(l)}if(h!==null)var _t=!0;else{var tt=n(u);tt!==null&&K(w,tt.startTime-U),_t=!1}return _t}finally{h=null,d=H,m=!1}}var S=!1,k=null,I=-1,O=5,P=-1;function B(){return!(t.unstable_now()-P<O)}function te(){if(k!==null){var D=t.unstable_now();P=D;var U=!0;try{U=k(!0,D)}finally{U?M():(S=!1,k=null)}}else S=!1}var M;if(typeof f=="function")M=function(){f(te)};else if(typeof MessageChannel<"u"){var G=new MessageChannel,N=G.port2;G.port1.onmessage=te,M=function(){N.postMessage(null)}}else M=function(){T(te,0)};function z(D){k=D,S||(S=!0,M())}function K(D,U){I=T(function(){D(t.unstable_now())},U)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){y||m||(y=!0,z(E))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):O=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(d){case 1:case 2:case 3:var U=3;break;default:U=d}var H=d;d=U;try{return D()}finally{d=H}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,U){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var H=d;d=D;try{return U()}finally{d=H}},t.unstable_scheduleCallback=function(D,U,H){var ae=t.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?ae+H:ae):H=ae,D){case 1:var ce=-1;break;case 2:ce=250;break;case 5:ce=1073741823;break;case 4:ce=1e4;break;default:ce=5e3}return ce=H+ce,D={id:c++,callback:U,priorityLevel:D,startTime:H,expirationTime:ce,sortIndex:-1},H>ae?(D.sortIndex=H,e(u,D),n(l)===null&&D===n(u)&&(_?(g(I),I=-1):_=!0,K(w,H-ae))):(D.sortIndex=ce,e(l,D),y||m||(y=!0,z(E))),D},t.unstable_shouldYield=B,t.unstable_wrapCallback=function(D){var U=d;return function(){var H=d;d=U;try{return D.apply(this,arguments)}finally{d=H}}}})(Dy);(function(t){t.exports=Dy})(xy);/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jr=new vf("@firebase/firestore");function yg(){return jr.logLevel}function F(t,...e){if(jr.logLevel<=ie.DEBUG){const n=e.map(zf);jr.debug(`Firestore (${Yi}): ${t}`,...n)}}function xn(t,...e){if(jr.logLevel<=ie.ERROR){const n=e.map(zf);jr.error(`Firestore (${Yi}): ${t}`,...n)}}function od(t,...e){if(jr.logLevel<=ie.WARN){const n=e.map(zf);jr.warn(`Firestore (${Yi}): ${t}`,...n)}}function zf(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class l_{constructor(e,n){this.user=n,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class kN{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,n){e.enqueueRetryable(()=>n(Ke.UNAUTHENTICATED))}shutdown(){}}class IN{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,n){this.changeListener=n,e.enqueueRetryable(()=>n(this.token.user))}shutdown(){this.changeListener=null}}class TN{constructor(e){this.t=e,this.currentUser=Ke.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,n){let r=this.i;const i=l=>this.i!==r?(r=this.i,n(l)):Promise.resolve();let s=new En;this.o=()=>{this.i++,this.currentUser=this.u(),s.resolve(),s=new En,e.enqueueRetryable(()=>i(this.currentUser))};const o=()=>{const l=s;e.enqueueRetryable(async()=>{await l.promise,await i(this.currentUser)})},a=l=>{F("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=l,this.auth.addAuthTokenListener(this.o),o()};this.t.onInit(l=>a(l)),setTimeout(()=>{if(!this.auth){const l=this.t.getImmediate({optional:!0});l?a(l):(F("FirebaseAuthCredentialsProvider","Auth not yet detected"),s.resolve(),s=new En)}},0),o()}getToken(){const e=this.i,n=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(n).then(r=>this.i!==e?(F("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(ue(typeof r.accessToken=="string"),new l_(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}u(){const e=this.auth&&this.auth.getUid();return ue(e===null||typeof e=="string"),new Ke(e)}}class CN{constructor(e,n,r,i){this.h=e,this.l=n,this.m=r,this.g=i,this.type="FirstParty",this.user=Ke.FIRST_PARTY,this.p=new Map}I(){return this.g?this.g():(ue(!(typeof this.h!="object"||this.h===null||!this.h.auth||!this.h.auth.getAuthHeaderValueForFirstParty)),this.h.auth.getAuthHeaderValueForFirstParty([]))}get headers(){this.p.set("X-Goog-AuthUser",this.l);const e=this.I();return e&&this.p.set("Authorization",e),this.m&&this.p.set("X-Goog-Iam-Authorization-Token",this.m),this.p}}class NN{constructor(e,n,r,i){this.h=e,this.l=n,this.m=r,this.g=i}getToken(){return Promise.resolve(new CN(this.h,this.l,this.m,this.g))}start(e,n){e.enqueueRetryable(()=>n(Ke.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class RN{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class xN{constructor(e){this.T=e,this.forceRefresh=!1,this.appCheck=null,this.A=null}start(e,n){const r=s=>{s.error!=null&&F("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${s.error.message}`);const o=s.token!==this.A;return this.A=s.token,F("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?n(s.token):Promise.resolve()};this.o=s=>{e.enqueueRetryable(()=>r(s))};const i=s=>{F("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=s,this.appCheck.addTokenListener(this.o)};this.T.onInit(s=>i(s)),setTimeout(()=>{if(!this.appCheck){const s=this.T.getImmediate({optional:!0});s?i(s):F("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(n=>n?(ue(typeof n.token=="string"),this.A=n.token,new RN(n.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fo(t){if(t.code!==C.FAILED_PRECONDITION||t.message!==bN)throw t;F("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cx extends class{constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const n=e.ssl?"https":"http";this.oo=n+"://"+e.host,this.uo="projects/"+this.databaseId.projectId+"/databases/"+this.databaseId.database+"/documents"}get co(){return!1}ao(e,n,r,i,s){const o=this.ho(e,n);F("RestConnection","Sending: ",o,r);const a={};return this.lo(a,i,s),this.fo(e,o,a,r).then(l=>(F("RestConnection","Received: ",l),l),l=>{throw od("RestConnection",`${e} failed with error: `,l,"url: ",o,"request:",r),l})}_o(e,n,r,i,s,o){return this.ao(e,n,r,i,s)}lo(e,n,r){e["X-Goog-Api-Client"]="gl-js/ fire/"+Yi,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),n&&n.headers.forEach((i,s)=>e[s]=i),r&&r.headers.forEach((i,s)=>e[s]=i)}ho(e,n){const r=lx[e];return`${this.oo}/v1/${n}:${r}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams}fo(e,n,r,i){return new Promise((s,o)=>{const a=new SN;a.setWithCredentials(!0),a.listenOnce(wN.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case Pc.NO_ERROR:const u=a.getResponseJson();F("Connection","XHR received:",JSON.stringify(u)),s(u);break;case Pc.TIMEOUT:F("Connection",'RPC "'+e+'" timed out'),o(new V(C.DEADLINE_EXCEEDED,"Request time out"));break;case Pc.HTTP_ERROR:const c=a.getStatus();if(F("Connection",'RPC "'+e+'" failed with status:',c,"response text:",a.getResponseText()),c>0){const h=a.getResponseJson().error;if(h&&h.status&&h.message){const d=function(m){const y=m.toLowerCase().replace(/_/g,"-");return Object.values(C).indexOf(y)>=0?y:C.UNKNOWN}(h.status);o(new V(d,h.message))}else o(new V(C.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new V(C.UNAVAILABLE,"Connection failed."));break;default:Q()}}finally{F("Connection",'RPC "'+e+'" completed.')}});const l=JSON.stringify(i);a.send(n,"POST",l,r,15)})}wo(e,n,r){const i=[this.oo,"/","google.firestore.v1.Firestore","/",e,"/channel"],s=yN(),o=vN(),a={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling};this.useFetchStreams&&(a.xmlHttpFactory=new EN({})),this.lo(a.initMessageHeaders,n,r),a.encodeInitMessageHeaders=!0;const l=i.join("");F("Connection","Creating WebChannel: "+l,a);const u=s.createWebChannel(l,a);let c=!1,h=!1;const d=new ux({Hr:y=>{h?F("Connection","Not sending because WebChannel is closed:",y):(c||(F("Connection","Opening WebChannel transport."),u.open(),c=!0),F("Connection","WebChannel sending:",y),u.send(y))},Jr:()=>u.close()}),m=(y,_,T)=>{y.listen(_,g=>{try{T(g)}catch(f){setTimeout(()=>{throw f},0)}})};return m(u,ya.EventType.OPEN,()=>{h||F("Connection","WebChannel transport opened.")}),m(u,ya.EventType.CLOSE,()=>{h||(h=!0,F("Connection","WebChannel transport closed"),d.io())}),m(u,ya.EventType.ERROR,y=>{h||(h=!0,od("Connection","WebChannel transport errored:",y),d.io(new V(C.UNAVAILABLE,"The operation could not be completed")))}),m(u,ya.EventType.MESSAGE,y=>{var _;if(!h){const T=y.data[0];ue(!!T);const g=T,f=g.error||((_=g[0])===null||_===void 0?void 0:_.error);if(f){F("Connection","WebChannel received error:",f);const p=f.status;let w=function(S){const k=Te[S];if(k!==void 0)return N_(k)}(p),E=f.message;w===void 0&&(w=C.INTERNAL,E="Unknown error status: "+p+" with message "+f.message),h=!0,d.io(new V(w,E)),u.close()}else F("Connection","WebChannel received:",T),d.ro(T)}}),m(o,_N.STAT_EVENT,y=>{y.stat===mg.PROXY?F("Connection","Detected buffering proxy"):y.stat===mg.NOPROXY&&F("Connection","Detected no buffering proxy")}),setTimeout(()=>{d.so()},0),d}}function bc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fx extends class{}{constructor(e,n,r,i){super(),this.authCredentials=e,this.appCheckCredentials=n,this.So=r,this.It=i,this.su=!1}iu(){if(this.su)throw new V(C.FAILED_PRECONDITION,"The client has already been terminated.")}ao(e,n,r){return this.iu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([i,s])=>this.So.ao(e,n,r,i,s)).catch(i=>{throw i.name==="FirebaseError"?(i.code===C.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),i):new V(C.UNKNOWN,i.toString())})}_o(e,n,r,i){return this.iu(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then(([s,o])=>this.So._o(e,n,r,s,o,i)).catch(s=>{throw s.name==="FirebaseError"?(s.code===C.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),s):new V(C.UNKNOWN,s.toString())})}terminate(){this.su=!0}}class px{constructor(e,n){this.asyncQueue=e,this.onlineStateHandler=n,this.state="Unknown",this.ru=0,this.ou=null,this.uu=!0}cu(){this.ru===0&&(this.au("Unknown"),this.ou=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,()=>(this.ou=null,this.hu("Backend didn't respond within 10 seconds."),this.au("Offline"),Promise.resolve())))}lu(e){this.state==="Online"?this.au("Unknown"):(this.ru++,this.ru>=1&&(this.fu(),this.hu(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.au("Offline")))}set(e){this.fu(),this.ru=0,e==="Online"&&(this.uu=!1),this.au(e)}au(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}hu(e){const n=`Could not reach Cloud Firestore backend. ${e}
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.uu?(xn(n),this.uu=!1):F("OnlineStateTracker",n)}fu(){this.ou!==null&&(this.ou.cancel(),this.ou=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function n1(t,e,n){if(!n)throw new V(C.INVALID_ARGUMENT,`Function ${t}() cannot be called with an empty ${e}.`)}function Gx(t,e,n,r){if(e===!0&&r===!0)throw new V(C.INVALID_ARGUMENT,`${t} and ${n} cannot be used together.`)}function zg(t){if(!j.isDocumentKey(t))throw new V(C.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`)}function jg(t){if(j.isDocumentKey(t))throw new V(C.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`)}function cp(t){if(t===void 0)return"undefined";if(t===null)return"null";if(typeof t=="string")return t.length>20&&(t=`${t.substring(0,20)}...`),JSON.stringify(t);if(typeof t=="number"||typeof t=="boolean")return""+t;if(typeof t=="object"){if(t instanceof Array)return"an array";{const e=function(n){return n.constructor?n.constructor.name:null}(t);return e?`a custom ${e} object`:"an object"}}return typeof t=="function"?"a function":Q()}function Ut(t,e){if("_delegate"in t&&(t=t._delegate),!(t instanceof e)){if(e.name===t.constructor.name)throw new V(C.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const n=cp(t);throw new V(C.INVALID_ARGUMENT,`Expected type '${e.name}', but it was: ${n}`)}}return t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zi{constructor(e){this._byteString=e}static fromBase64String(e){try{return new zi(et.fromBase64String(e))}catch(n){throw new V(C.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+n)}}static fromUint8Array(e){return new zi(et.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ou{constructor(...e){for(let n=0;n<e.length;++n)if(e[n].length===0)throw new V(C.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Qe(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dp{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new V(C.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new V(C.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return se(this._lat,e._lat)||se(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cE="storage";function yy(t,e,n){return t=_e(t),DP(t,e,n)}function vy(t){return t=_e(t),AP(t)}function wy(t){return t=_e(t),OP(t)}function ka(t,e){return t=_e(t),$P(t,e)}function Ia(t=_f(),e){t=_e(t);const r=su(t,cE).getImmediate({identifier:e}),i=J0("storage");return i&&UP(r,...i),r}function UP(t,e,n,r={}){MP(t,e,n,r)}function FP(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),r=t.getProvider("auth-internal"),i=t.getProvider("app-check-internal");return new Pp(n,r,i,e,Gi)}function VP(){zr(new ar(cE,FP,"PUBLIC").setMultipleInstances(!0)),sn(my,gy,""),sn(my,gy,"esm2017")}VP();function BP(){const[t,e]=A.exports.useState(!1),[n,r]=A.exports.useState([]);async function i(){const f=new pn;await FA(rt(),f)}function s(){mA(rt())}async function o(f,p,w){try{const E=rt().currentUser.uid,S=await Mc(ms(nt(),`users/${E}/habits`),f),k=ms(S,"todos"),I=`users/${E}/${p.name}`,O=ka(Ia(),I),P=await yy(O,p),B=await vy(O),te=P.metadata.fullPath;for(let M=0;M<w.length;M++){const G=await Mc(k,w[M]);await At(G,{refId:G.id})}await At(S,{image:B,storageURI:te,refId:S.id})}catch(E){console.log(`ERROR : ${E}`)}}async function a(f,p){try{const w=rt().currentUser.uid,E=ka(Ia(),f.storageURI),S=Ot(nt(),`users/${w}/habits`,f.refId),k=`users/${w}/${f.refId}/${p.name}`,I=ka(Ia(),k);let O,P,B;At(S,{image:null}),O=await yy(I,p),P=await vy(I),B=O.metadata.fullPath,await At(S,{image:P,storageURI:B}),await wy(E)}catch(w){console.log(`ERROR WHILE ATTEMPMTING TO REPLACE IMAGE: ${w}`)}}async function l(f,p){try{const w=rt().currentUser.uid,E=Ot(nt(),`users/${w}/habits/${f}`);await At(E,{[p.label]:p.value})}catch(w){console.log(`ERROR UPDATING DETAIL: ${w}`)}}function u(f,p,w,E){const S=n.findIndex(M=>M.refId===p),k=n[S],I=k.todos.findIndex(M=>M.refId===w),O=k.todos[I];let P,B,te;return P=[...O.dates],P.includes(E)?P=P.filter(M=>M!==E):P.push(E),B={...O,dates:P},te=k.todos.slice(0,I).concat(B).concat(k.todos.slice(I+1)),f.slice(0,S).concat({...k,todos:te}).concat(f.slice(S+1))}async function c(f,p,w){try{const E=rt().currentUser.uid,S=Ot(nt(),`users/${E}/habits/${f}/todos/${p}`),k=await _D(S);let I;r(O=>u(O,f,p,w)),I=k.data().dates,I.includes(w)?I=I.filter(O=>O!==w):I.push(w),await At(S,{dates:I})}catch(E){console.log(E)}}async function h(f){try{const p=rt().currentUser.uid,w=Ot(nt(),`users/${p}/habits/${f}`),E=n.find(I=>I.refId===f),S=E.todos.map(I=>I.refId),k=ka(Ia(),E.storageURI);await wy(k);for(let I of S){const O=Ot(nt(),`user/${p}/habits/${f}/todos/${I}`);await $c(O)}await $c(w),window.location.href="/"}catch(p){console.log(`ERROR, COULDN'T DELETE HABIT : ${p}`)}}async function d(f,p,w,E){const S=rt().currentUser.uid,k=Ot(nt(),`users/${S}/habits/${f}/todos/${p}`),I=n.findIndex(N=>N.refId===f),O=n[I],P=O.todos.findIndex(N=>N.refId===p),B=O.todos[P],te=B.dates.filter(N=>bi(new Date(N),w)),M=O.todos.slice(0,P).concat({...B,range:w,dates:te}).concat(O.todos.slice(P+1));let G;if(G=n.slice(0,I).concat({...O,todos:M}).concat(n.slice(I+1)),await At(k,{range:w,dates:te}),r(G),E){const N=m(G,O.refId),z=Ot(nt(),`users/${S}/habits/${f}/todos/${O.todos[0].refId}`),K={name:O.name,id:Si(),range:{from:"free",to:"free"},dates:[...O.todos[0].dates],index:O.todos.length};G=N.data,await At(z,{dates:[]}),y(f,K)}}function m(f,p){const w=f.findIndex(I=>I.refId===p),E=f[w],S={name:E.name,id:Si(),range:{from:"free",to:"free"},dates:[...E.todos[0].dates]},k=[...E.todos.slice(1),S];return k.unshift({...E.todos[0],dates:[]}),{data:f.slice(0,w).concat({...E,todos:k}).concat(f.slice(w+1)),todo:S}}async function y(f,p){const w=n.findIndex(B=>B.refId===f),E=n[w],S=E.todos[0].dates.filter(B=>B!=p.range.from),k=[{...E.todos[0],dates:S},...E.todos.slice(1),p],I=rt().currentUser.uid,O=ms(nt(),`users/${I}/habits/${f}/todos`),P=await Mc(O,p);if(p.refId=P.id,r(B=>B.slice(0,w).concat({...E,todos:k}).concat(B.slice(w+1))),E.todos[0].dates.some(B=>B===p.range.from)){const B=Ot(nt(),`users/${I}/habits/${f}/todos/${E.todos[0].refId}`),te=E.todos[0].dates.filter(M=>M!==p.range.from);await At(B,{dates:te})}await At(P,{refId:P.id})}async function _(f,p){try{const w=rt().currentUser.uid,E=Ot(nt(),`users/${w}/habits/${f}/todos/${p}`),S=n.findIndex(O=>O.refId===f),k=n[S],I=k.todos.filter(O=>O.refId!==p);I.forEach(async(O,P)=>{if(!!P)try{const B=Ot(nt(),`users/${w}/habits/${f}/todos/${O.refId}`);await At(B,{index:P})}catch(B){console.log(`ERROR UPDATING INDEX: ${B}`)}}),r(O=>O.slice(0,S).concat({...k,todos:I}).concat(O.slice(S+1))),await $c(E)}catch(w){console.log(`ERROR DELETING TODO: ${w}`)}}async function T(f,p,w){try{const E=rt().currentUser.uid,S=Ot(nt(),`users/${E}/habits/${f}/todos/${p}`),k=n.findIndex(te=>te.refId===f),I=n[k],O=I.todos.findIndex(te=>te.refId===p),P=I.todos[O],B=I.todos.slice(0,O).concat({...P,name:w}).concat(I.todos.slice(O+1));r(te=>te.slice(0,k).concat({...I,todos:B}).concat(te.slice(k+1))),await At(S,{name:w})}catch(E){console.log(`ERROR UPDATING TODO NAME: ${E}`)}}function g(){const f=rt().currentUser.uid,p=fD(ms(nt(),`users/${f}/habits`),mD("timestamp","asc"));return SD(p,E=>E.docChanges().forEach(async S=>{if(S.type==="removed")r(k=>k.filter(I=>I.id!==S.doc.id));else{const k=S.doc.data(),I=ms(nt(),`users/${f}/habits/${k.refId}/todos`),O=await ED(I),P=[];O.forEach(B=>P.push(B.data())),P.sort((B,te)=>B.index-te.index),r(B=>{const te=B.findIndex(M=>M.id===k.id);return~te?B.slice(0,te).concat({...k,todos:P}).concat(B.slice(te+1)):[...B,k]})}}))}return A.exports.useEffect(()=>{rw(xD)},[]),A.exports.useEffect(()=>{let f;return pA(rt(),()=>{e(()=>!!rt().currentUser),rt().currentUser&&(f=g())}),()=>f?f():null},[]),v("div",{className:"App",children:b(bI,{children:[b("nav",{className:"navbar",children:[v("div",{className:"logo",children:"Kerosene"}),b("ul",{className:"links",children:[v("li",{children:v(Kg,{path:"/Habit-Tracker",icon:ND})}),v("li",{children:v(Kg,{path:"/Habit-Tracker/info",icon:RD})}),t?v("li",{children:v("button",{className:"log-out-button",onClick:s})}):null]})]}),t?b(DI,{children:[v(Es,{element:v(CD,{habits:n,update:c,add_habit:o}),path:"/Habit-Tracker"}),v(Es,{element:v(MI,{}),path:"/Habit-Tracker/info"}),n.map(f=>v(Es,{path:`/Habit-Tracker/habits/${f.id}`,element:v(HI,{habit:f,update_cell:c,update_detail:l,change_image:a,delete_habit:h,toggle_habit_range:d,add_todo_to_habit:y,delete_todo:_,rename_todo:T})},f.id)),v(Es,{path:"*",element:v("p",{children:"Not found"})})]}):v("div",{className:"sign-in-content",children:v("button",{onClick:i,children:"Log In"})}),b("footer",{className:"footer",children:["A project by"," ",v("a",{href:"https://ol.reddit.com/u/_by_me",target:"_blank",children:"u/_by_me"}),", \xA9 2022"]})]})})}Hc.createRoot(document.getElementById("root")).render(v(Ny.StrictMode,{children:v(BP,{})}));
