 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(D,U){var j=D.length;D.push(U);e:for(;0<j;){var ae=j-1>>>1,he=D[ae];if(0<i(he,U))D[ae]=U,D[j]=he,j=ae;else break e}}function n(D){return D.length===0?null:D[0]}function r(D){if(D.length===0)return null;var U=D[0],j=D.pop();if(j!==U){D[0]=j;e:for(var ae=0,he=D.length,Nt=he>>>1;ae<Nt;){var tt=2*(ae+1)-1,H=D[tt],re=tt+1,le=D[re];if(0>i(H,j))re<he&&0>i(le,H)?(D[ae]=le,D[re]=j,ae=re):(D[ae]=H,D[tt]=j,ae=tt);else if(re<he&&0>i(le,j))D[ae]=le,D[re]=j,ae=re;else break e}}return U}function i(D,U){var j=D.sortIndex-U.sortIndex;return j!==0?j:D.id-U.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,m=!1,y=!1,_=!1,I=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(D){for(var U=n(u);U!==null;){if(U.callback===null)r(u);else if(U.startTime<=D)r(u),U.sortIndex=U.expirationTime,e(l,U);else break;U=n(u)}}function v(D){if(_=!1,p(D),!y)if(n(l)!==null)y=!0,B(E);else{var U=n(u);U!==null&&G(v,U.startTime-D)}}function E(D,U){y=!1,_&&(_=!1,g(T),T=-1),m=!0;var j=d;try{for(p(U),h=n(l);h!==null&&(!(h.expirationTime>U)||D&&!te());){var ae=h.callback;if(typeof ae=="function"){h.callback=null,d=h.priorityLevel;var he=ae(h.expirationTime<=U);U=t.unstable_now(),typeof he=="function"?h.callback=he:h===n(l)&&r(l),p(U)}else r(l);h=n(l)}if(h!==null)var Nt=!0;else{var tt=n(u);tt!==null&&G(v,tt.startTime-U),Nt=!1}return Nt}finally{h=null,d=j,m=!1}}var S=!1,k=null,T=-1,b=5,x=-1;function te(){return!(t.unstable_now()-x<b)}function pe(){if(k!==null){var D=t.unstable_now();x=D;var U=!0;try{U=k(!0,D)}finally{U?$():(S=!1,k=null)}}else S=!1}var $;if(typeof f=="function")$=function(){f(pe)};else if(typeof MessageChannel<"u"){var Y=new MessageChannel,R=Y.port2;Y.port1.onmessage=pe,$=function(){R.postMessage(null)}}else $=function(){I(pe,0)};function B(D){k=D,S||(S=!0,$())}function G(D,U){T=I(function(){D(t.unstable_now())},U)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(D){D.callback=null},t.unstable_continueExecution=function(){y||m||(y=!0,B(E))},t.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<D?Math.floor(1e3/D):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(D){switch(d){case 1:case 2:case 3:var U=3;break;default:U=d}var j=d;d=U;try{return D()}finally{d=j}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(D,U){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var j=d;d=D;try{return U()}finally{d=j}},t.unstable_scheduleCallback=function(D,U,j){var ae=t.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?ae+j:ae):j=ae,D){case 1:var he=-1;break;case 2:he=250;break;case 5:he=1073741823;break;case 4:he=1e4;break;default:he=5e3}return he=j+he,D={id:c++,callback:U,priorityLevel:D,startTime:j,expirationTime:he,sortIndex:-1},j>ae?(D.sortIndex=j,e(u,D),n(l)===null&&D===n(u)&&(_?(g(T),T=-1):_=!0,G(v,j-ae))):(D.sortIndex=he,e(l,D),y||m||(y=!0,B(E))),D},t.unstable_shouldYield=te,t.unstable_wrapCallback=function(D){var U=d;return function(){var j=d;d=U;try{return D.apply(this,arguments)}finally{d=j}}}})(Iy);(function(t){t.exports=Iy})(Ty);/**
 * @license React
